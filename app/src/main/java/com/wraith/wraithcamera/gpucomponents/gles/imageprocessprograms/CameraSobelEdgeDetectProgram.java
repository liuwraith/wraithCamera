 ...
 */
public class CameraSobelEdgeDetectProgram extends Texture2dProgram{
    ...
    public CameraSobelEdgeDetectProgram(Context context, int width, int height){
        mWidth = width;
        mHeight = height;
        mFilterType = FilterType.SOBEL_EDGE_DETECTIVE;

        mProgramHandle = GlUtil.createProgram(VERTEX_SHADER,
                RawResourceReader.readTextFileFromRawResource(context, R.raw.sobel_edge_detect));
