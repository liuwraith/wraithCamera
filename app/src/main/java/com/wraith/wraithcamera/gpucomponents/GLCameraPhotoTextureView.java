...
/**
 * Created by liuzongyang on 15/4/20.
 */
/*
...
import com.wraith.wraithcamera.gpucomponents.gles.EGLLogWrapperProxy;
import com.wraith.wraithcamera.gpucomponents.gles.SystemPropertiesProxy;
 ...
 *
 */
public class GLCameraPhotoTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public void setIsCameraReady(boolean isReady) {
        mIsCameraReady = isReady;
    }
    ...
    public GLCameraPhotoTextureView(Context context) {
        super(context);
        mContext = context;
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public GLCameraPhotoTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GLCameraPhotoTextureView> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            GLCameraPhotoTextureView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        public static String formatEglError(String function, int error) {
            return function + " failed: " + EGLLogWrapperProxy.getErrorString(error);
        }

        private WeakReference<GLCameraPhotoTextureView> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
        ...
        mGLThread.queueEvent(new Runnable() {
            ...
            public void run() {
                synchronized (sGLThreadManager) {
                    mGLThread.stopEglSurfaceLocked();
                    mGLThread.stopEglContextLocked();
                }
            }
        });
    }
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLCameraPhotoTextureView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
        ...
        private boolean readyToDraw() {
            return (!mPaused) && mHasSurface && (!mSurfaceIsBad)
                    && (mWidth > 0) && (mHeight > 0)
                    && (mRequestRender || (mRenderMode == RENDERMODE_CONTINUOUSLY)) && mGLSurfaceViewWeakRef != null
                    && mGLSurfaceViewWeakRef.get() != null && mGLSurfaceViewWeakRef.get().mIsCameraReady;
        }
        ...
        public void onResume() {
            synchronized (sGLThreadManager) {
                ...
                Log.i("wraith", "mExited " + mExited + " mPaused " + mPaused + "  mRenderComplete " + mRenderComplete);
                sGLThreadManager.notifyAll();
    ...
    private static class GLThreadManager {
        ...
        private void checkGLESVersion() {
            if (! mGLESVersionCheckComplete) {
                mGLESVersion = SystemPropertiesProxy.getInt(GLCameraPhotoTextureView.mContext,
                        "ro.opengles.version",
                ...
                GLCameraPhotoTextureView.mContext = null;
    ...
    private final WeakReference<GLCameraPhotoTextureView> mThisWeakRef = new WeakReference<GLCameraPhotoTextureView>(this);
    ...
    /*Interface callback*/
    public static interface FinishDrawCallBackListener{
        void onDrawOver();
    }

    private static FinishDrawCallBackListener SFinishDrawCallBackListener = null;

    public void setmFinishDrawCallBackListener(FinishDrawCallBackListener listener){
        SFinishDrawCallBackListener = listener;
    }
}
