...
/**
 * Created by liuzongyang on 15/6/9.
 */
public class CameraMeiFuMeiBaiProgram extends Texture2dProgram {
    ...
    public CameraMeiFuMeiBaiProgram(Context context, int width, int height){
        mWidth = width;
        mHeight = height;
        mFilterType = FilterType.MEI_FU;
        mDefaultTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;

        String sharpFragment = RawResourceReader.readTextFileFromRawResource(context, R.raw.sharp_of_smooth_skin);
...
//        drawSharp(mvpMatrix, vertexBuffer, firstVertex, vertexCount, coordsPerVertex,
//                vertexStride, texMatrix, texBuffer,texStride, textureId);
    }
