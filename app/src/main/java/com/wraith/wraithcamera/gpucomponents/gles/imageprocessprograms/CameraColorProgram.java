 ...
 */
public class CameraColorProgram extends Texture2dProgram {
    private int muRatioLoc;

    private int mWidth;
    private int mHeight;

    public CameraColorProgram(Context context, int width, int height){
        super();
        mWidth = width;
        mHeight = height;
        mFilterType = FilterType.COLOR_FILTER;
        //TODO
        mProgramHandle = GlUtil.createProgram(VERTEX_SHADER,
                RawResourceReader.readTextFileFromRawResource(context, R.raw.adjust_colortype));
    ...
    protected void initParams(){
        ...
        muRatioLoc = GLES20.glGetUniformLocation(mProgramHandle, "u_ColorRatio");
